...
class TopicModeling(Step):
    ...
    def __init__(self):
        ...
        self.__experiments = pd.DataFrame(columns=['model_name', 'num_topics', 'chunksize', 'passes', 'iterations', 'execution_time', 'coherence'])
    ...
    def __saveExperiment(self, model_name, num_topics, chunksize, passes, iterations, execution_time, coherence):
                ...
                for chunksize in chunksize_list:
                    for num_topics in num_topics_list:
                        for model_name in model_name_list:
                            ...
                            self.__model.build(model_name, num_topics, chunksize, passes, iterations, self.__corpus)
                            coherence = self.__model.getCoherence()
                            # Save experiment to file
                            self.__saveExperiment(model_name, num_topics, chunksize, passes, iterations, start_time+time(), coherence)
